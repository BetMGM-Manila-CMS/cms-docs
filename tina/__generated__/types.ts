...
export type MembersPartsFragment = { __typename: 'Members', member?: Array<{ __typename: 'MembersMember', image?: string | null, name: string, title: string, isProbation: boolean, officeLocation: string } | null> | null };
