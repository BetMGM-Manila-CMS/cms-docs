...
export default function QA() {
    ...
    return (
        <section className="container relative mb-8 relative">
            <div className="max-w-screen-xl px-4 pb-4 mx-auto sm:pb-8 lg:px-6 flex flex-col items-center relative z-10">
            ...
            <div className="md:columns-2">
                <div className="flex justify-center p-4 flex-col">
                    <h2 className="text-center">Last 5 Months QA Score</h2>
                ...
                <div className="flex justify-center p-4 flex flex-col items-center">
                    <div className="flex flex-col items-center mb-2 md:mb-4">
                        <h2 className="">Current Month's QA</h2>
