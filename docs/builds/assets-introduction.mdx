import sampleBoxLinks from "../../static/img/builds/assets/sample-box-links.png"
import folderSize from "../../static/img/builds/assets/assets-2-folder.png"
...
<img className="w-3/4 max-w-md mt-4" src={sampleBoxLinks} alt="Image alt" />
...
<img className="w-full mt-4" src={folderSize} alt="Image alt" />
