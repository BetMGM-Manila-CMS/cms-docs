...
<Admonition type="tip" title="Multiple Box Links">
...
If you encounter assets exceeding the required minimum size, either [compress the images](./assets-request.mdx) or [request for new assets](./assets-request.mdx)
