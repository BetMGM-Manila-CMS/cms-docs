...
<TinaTable>
  ...
  <TinaTableRow items={[{ label: "PromotionTitle " }, { label: "Promohub H1" }]} />

  <TinaTableRow items={[{ label: "Image" }, { label: "Media URL link" }]} />
  ...
  <TinaTableRow items={[{ label: "Terms And Conditions" }, { label: "TnCs" }]} />
</TinaTable>
...
<Admonition type="note" title="Updating Game Tile">
...
<TinaTable>
  ...
  <TinaTableRow
    items={[
      { label: "Desktop" },
      {
        label: 'data-content-filter="NOT Device.IsMobile AND NOT Device.IsTablet"',
        code: true,
        style: "code"
      }
    ]}
  ...
  <TinaTableRow
    items={[
      { label: "Mobile" },
      {
        label: 'data-content-filter="Device.IsMobile OR Device.IsTablet"',
        code: true,
        style: "code"
      }
    ]}
...
<TinaTable>
  ...
  <TinaTableRow items={[{ label: "DGC" }, { label: "mobile" }]} />

  <TinaTableRow items={[{ label: "NETENT" }, { label: "touch" }]} />
</TinaTable>
