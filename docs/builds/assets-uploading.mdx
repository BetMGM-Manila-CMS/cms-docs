...
<TinaTable>
  <TinaTableRow
    items={[
      ...
      { label: "Borgata", header: true },
      { label: "PartyCasino", header: true },
      { label: "partypoker", header: true }
    ]}
  />

  <TinaTableRow
    items={[
      { label: "Casino", header: true },
      { label: "Year > Month", style: "highlight" },
      { label: "Year > Month", style: "highlight" },
      { label: "Year > Month", style: "highlight" },
      { label: "" }
    ]}
  ...
  <TinaTableRow
    items={[
            ...
            {
                label: "BetMGM-Poker > Year > Month",
                style: "highlight"
            },
            {
                label: "BorgataPoker > Year > Month",
                style: "highlight"
            },
            {
                label: "",
  ...
  <TinaTableRow
    items={[
            ...
            {
                label: "BetMGM-Sports > Year > Month",
                style: "highlight"
            },
            {
                label: "BorgataSports > Year > Month",
                style: "highlight"
            },
            {
                label: "",
