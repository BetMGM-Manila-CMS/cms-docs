...
| URLs | !!M2.Portal/mobileportal/promotions/casino/URL |
...
Find your Carousels in the left box then select and click the right arrow button. Do this for both Desktop and Mobile carousels. Then save and finalize.
