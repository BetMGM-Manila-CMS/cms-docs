...
![Landing Page Sample](/img/builds/landing-page/LandingPagePage.png)

### Sample Motion Landing Page
![Motion Landing Page Sample](/img/builds/landing-page/motion1.png)
...
![Alt text](/img/builds/landing-page/staticlpdup.png)

For the Motion LP, look for this:  

![Alt text](/img/builds/landing-page/motionlpdup.png)

As there are a different Code for these LP, as seen below:  

![Alt text](/img/builds/landing-page/difference.png)
...
![Landing Page Sample](/img/builds/landing-page/url.png)

Then you'll paste the URL on its respective key:

#### Static LP Hero
![Landing Page Sample](/img/builds/landing-page/Hero.png)
...
![Alt text](/img/builds/landing-page/motion hero.png)
...
![Landing Page Sample](/img/builds/landing-page/steps.png)
...
![Landing Page Sample](/img/builds/landing-page/terms.png)

#### Sports

![Landing Page Sample](/img/builds/landing-page/sports.png)
